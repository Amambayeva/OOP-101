import java.util.Scanner;
    ...
    public class Convertor {
        public static String[] small_numbers = {"", "one", "two", "three", "four",
                ...
                "eighteen", "nineteen"};
        public static String[] large_numbers = {
        ...
        public static String inWords(int number) {
            ...
            if (number < 100) {
                return large_numbers[number / 10] + ((number % 10 != 0) ? " " : "") + small_numbers[number % 10];
            }
            if (number < 1000) {
                return small_numbers[number / 100] + " hundred " + "[and]" + ((number % 100 != 0) ? " " : "") + inWords(number % 100);
            }
            if (number < 100000) {
